...
Script will add a number of reads from BED to every nucleotide in the transcript. Results will be written into 2 files seperated by strand of the binding
'''
import sys
...
if sys.argv.__len__() == 4:
    ...
    print("python number_of_reads_per_nt.py <input_file> <output_file> <genome_file>")
